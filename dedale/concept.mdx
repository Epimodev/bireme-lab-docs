...
With Dédale, our aim is to provide the ideal tool to help companies and individuals build email communications with a consistent brand image, while spending as little time on it as possible.
...
- **Simplify collaboration:** since development and preview can be carried out within the application, and each department can access all the models and export them without any special technical skills,

<Warning>

*Without creating an account, storage is carried out in your browser's data, with a maximum limit (1 template max.). If you clean your history or browsing data, you risk losing your work.
...
- **[Can I e-mail?](https://www.canie-mail.com/) integration:** with automatic detection of `HTML` and `CSS` properties that are limited and poorly supported by e-mail clients. **Feature under development_**.
...
[Read the React Email documentation to learn more](https://react.e-mail/docs/introduction)
...
If you have ideas and/or comments that could help us improve Daedalus, you can make a [feature request via our dedicated channel](https://github.com/orgs/bireme-lab/discussions/new?category=ideas).
