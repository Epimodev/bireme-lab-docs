...
description: Simplify and make more intuitive the creation and use of email templates
---
...
With Dédale, you can centralize all your mail templates in a single tool and easily export them to all your services according to your different [use cases](/dedale/usages/emailing.mdx).
...
- **Automatic management of external dependencies:** you can import any dependencies available on [NPM](https://www.npmjs.com/), and Dédale will take care of downloading them for you.
- **Error handling and display in preview:** integration of a dedicated error handling system for mail template development
- **[Can I email?](https://www.caniemail.com/) integration:** with automatic detection of `HTML` and `CSS` properties that are limited and poorly supported by email clients. _Feature under development_.

<Info>

The application was designed using the [React Email](https://react.email/) library to ensure an optimal development experience by coding its email in [TypeScript](https://www.typescriptlang.org/) and with [React](https://react.dev/).
